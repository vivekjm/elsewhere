...
export function Garment({ item }: { item: Item }) {
  const key = useId().replaceAll(':', ''), color = item.color || '#8b8b73';
  const [failedImage, setFailedImage] = useState('');
  const shapes = {
    dress: <><path d="m65 24-10 36 15 37-37 94h114l-37-94 14-37-9-36-25 15Z"/><path className="seam" d="M66 26q25 28 48 0M71 96h37M74 100l-16 79M104 100l17 79"/></>,
    glasses: <><path fill="none" stroke={color} strokeWidth="8" d="M25 94q25-12 53 0v26q-28 20-49-5ZM103 94q25-12 53 0l-4 23q-25 20-49 3ZM77 99q13-10 27 0M25 94 17 62M156 94l9-32"/></>,
    tee: <>
      <path d="m60 36-28 11-24 38 29 18 13-20-3 95q44 9 88 0l-3-95 13 20 28-18-24-38-28-11q-29 12-61 0Z" />
      <path className="seam" d="M61 37q29 36 59 0M51 58l-1 25M132 58v25M50 170q40 8 82 0" />
    ...
    sweater: <>
      ...
      <path className="seam" d="M66 32q26 36 50 0M56 55 35 133M123 55l22 78M53 175q39 7 74 0" />
      <path
        fill={`url(#${key}-knit)`}
        opacity=".55"
        d="M57 66h65v106H57z" />
    ...
    puffer: <>
      ...
      <path className="seam" d="M69 30q19 40 42 0M90 45v144M59 143l16-4M105 139l17 4" />
    ...
    boots: <>
      <path
        d="m32 74 42 1 3 47 19 13q18 14 4 25l-69 4q-16-2-15-15l6-45 10-30Zm61-20 43 1 5 47 18 13q17 14 4 25l-67 5q-16-2-15-15l4-45 8-31Z" />
      <path fill="#393832" d="M16 149q40 9 88-2l-1 15q-29 10-84 4ZM82 127q44 9 85-1l-3 16q-36 9-80 1Z" />
      <path className="rib" d="M33 91h30M32 101h32M30 111h34M30 121h39M95 70h29M94 80h32M91 90h34M91 100h35" />
      <path className="seam" d="M33 78 23 143M94 59l-10 62M41 140l30-6M103 121l33-8" />
    </>,
    sneakers: <>
      <path
        d="M26 87q19 6 24 27l37 14q22 5 21 25-43 13-94 3-6-16 2-36l10-33ZM88 55q21 8 26 29l37 16q20 6 18 25-42 14-93 2-5-15 1-36l11-36Z" />
      <path
        fill="#faf8f1"
        stroke="#b3b0a5"
        strokeWidth="1"
        d="M13 147q41 11 95-3v14q-45 14-94 5ZM75 120q44 9 95-4v15q-45 13-94 3Z" />
      <path className="rib" d="m38 112 21 6m-24 1 23 7m-28 2 23 7m48-52 23 8m-28 0 23 8m-26 1 24 7" />
    ...
    camera: <>
      <path fill="#292b29" d="M17 70h30l13-18h40l11 18h35q17 0 17 16v67q0 13-15 13H30q-14 0-14-14V83Z" />
    ...
    cap: <>
      ...
      <path className="seam" d="M98 52v77M89 53q-32 26-26 69M105 54q31 25 31 70" />
      <circle
        cx="96"
        cy="49"
        r="4" />
  ...
  return <svg
    ...
    <g
      ...
      {shapes[(item.shape === 'hat' ? 'cap' : item.shape) as keyof typeof shapes] || shapes[defaultShape(item.category) as keyof typeof shapes] || shapes.tee}
    </g>
  </svg>;
}
