...
export function Landscape({ theme = 'mountains', variant = '' }: { theme?: Theme; variant?: string }) {
  const key = useId().replaceAll(':', '');
  if (theme === 'coast') return (<svg
  ...
  if (theme === 'city') return (<svg
    ...
    <g fill="#c4b8a5">
      <path
        d="M420 300V98h73v202M504 300V144h92v156M607 300V60h102v240M722 300V118h66v182M802 300V78h91v222M907 300V145h93v155" />
    </g>
    <g fill="#9d9f8e">
    ...
    <g
      ...
      <path
        d="M443 117v169M471 117v169M633 77v197M669 77v197M829 96v97M868 96v97M716 180v105M757 180v105M792 180v105" />
    </g>
  ...
  return (<svg
    ...
    <path fill="#93a79b" d="m296 328 181-114 81 28 131-109 107 118 81-52 113 65 114-86 123 68v114H296Z" />
    <path fill="#647e6c" d="m410 360 139-89 134 49 131-81 113 73 131-76 160 54v70Z" />
    <path fill="#435e4d" d="m709 360 144-48 110 27 116-56 139 46v31Z" />
    <g fill="#364e3e" opacity=".82">
      <path
        d="m977 347 10-36 10 36h-6v13h-9v-13Zm31-8 13-45 13 45h-8v21h-10v-21Zm99-20 11-42 13 42h-8v22h-9v-22Zm-42 25 13-42 13 42h-8v16h-10v-16Z" />
    </g>
